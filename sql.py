...
class DadosClientes(Base):
    ...
    __table_args__ = (
        UniqueConstraint('cl_cnpj', 'cl_cpf', 'cl_estado_grupo', name='uq_cliente_2_cnpj_cpf_estado'),  # Define a restrição de unicidade composta
    )
...
class Veiculos_copy(Base):
    __tablename__ = 'veiculos_1_copy'
